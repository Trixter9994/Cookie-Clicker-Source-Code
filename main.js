...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		*/
						...
						if (Game.Click && Game.lastClickedEl==l('backgroundLeftCanvas'))
						{
							...
							else
							{
								...
								if (Game.prefs.particles && !(me.hp<=0.5 && me.phase>0))
								{
									...
									for (vradeCookie({name:'Stroopwafels',desc:'If it ain\'t dutch, it ain\'t much.',icon:[3,4],power:									2,	price:	9999999999999});
		Game.NewUpgradeCookie({name:'Macaroons',desc:'Not to be confused with macarons.<br>These have coconut, okay?',icon:[4,4],power:			2,	price:	9999999999999*5});
		...
		Game.NewUpgradeCookie({name:'Vanillekipferl',desc:'Nut-based cookies from Central Europe, coated in powdered vanilla sugar. Regular kipferl, crescent-shaped br
